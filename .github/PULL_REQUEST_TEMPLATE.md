# --------------------------------------------------------------
# Pull‑Request Template – core
# --------------------------------------------------------------

## Description
<!-- What does this PR do? Summarize the change in a few sentences. -->
...
## Checklist
- [ ] Version bump in `core/versions.json` (if this PR introduces a new release)
