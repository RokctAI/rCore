...
Example:
	...
	from rcore.gateways.utils import get_payment_gateway_controller
...
api_path = "/api/method/rcore.gateways.doctype.paypal_settings.paypal_settings"
...
def ipn_handler():
	try:
		...
		frappe.enqueue(
			method="rcore.gateways.doctype.paypal_settings.paypal_settings.handle_subscription_notification",
			queue="long",
			timeout=600,
			is_async=True,
