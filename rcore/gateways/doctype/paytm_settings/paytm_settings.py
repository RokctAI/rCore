...
def get_paytm_config():
	...
	if cint(paytm_config.staging):
		paytm_config.update(
			dict(
				website="WEBSTAGING",
				url="https://securestage.paytmpayments.com/order/process",
				transaction_status_url="https://securestage.paytmpayments.com/order/status",
...
def get_paytm_params(payment_details, order_id, paytm_config):
	...
	redirect_uri = (
		...
		+ "/api/method/rcore.gateways.doctype.paytm_settings.paytm_settings.verify_transaction"
	)
