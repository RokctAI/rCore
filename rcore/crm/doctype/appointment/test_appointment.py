...
from ..appointment.appointment import Appointment, _check_agent_availability, handle_expired_unverified_appointments
...
_test_holiday_list_mod = _erp_import("doctype.holiday_list.test_holiday_list")
make_holiday_list = _test_holiday_list_mod.make_holiday_list
