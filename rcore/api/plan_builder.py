            ...
            if secrets:
                ...
                try:
                    ...
                    if not config_file.exists():
                        default_provider = "gemini" if secrets.get("gemini_api_key") else "openrouter"
                        default_model = "google/gemini-2.5-pro" if default_provider == "gemini" else "google/gemini-2.5-pro"
