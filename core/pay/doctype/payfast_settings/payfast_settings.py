...
class PayFastSettings(PaymentGatewayController):
    def on_update(self):
        if not frappe.db.exists("Payment Gateway", "PayFast"):
            frappe.get_doc({
                ...
                "gateway_controller": "core.pay.doctype.payfast_settings.payfast_settings.PayFastSettings"
    ...
    def get_payment_url(self, **kwargs):
        ...
        payment_data = {
            ...
            "notify_url": frappe.utils.get_url("/api/method/core.pay.doctype.payfast_settings.payfast_settings.handle_payfast_callback"),
