...
def get_loan_product_list():
	...
	products = frappe.get_all(
		"Loan Product",
		fields=["name", "product_name", "rate_of_interest", "currency", "is_term_loan", "maximum_loan_amount", "min_days_bw_disbursement_first_repayment"]
	)
	...
	for p in products:
		...
		# Heuristic: You might want to customize this logic if you use different Item names
		for c in charges:
